...
Escher.prototype = {
    ...
    validateRequest: function (request, keyDB) {
        ...
        if (isPresignedUrl) {
            ...
            requestDate = this._config.dateHeaderName.toLowerCase() == 'date' ? new Date(getHeader(headers, this._config.dateHeaderName)) : escherUtil.parseLongDate(getHeader(headers, config.dateHeaderName));
