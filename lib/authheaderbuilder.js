...
var AuthHeaderBuilder = function () {
    ...
    function build(requestOptions, body, signerOptions) {
        ...
        return 'AWS4-HMAC-SHA256 Credential=AKIDEXAMPLE/' +
            escherUtil.toShortDate(signerOptions.date) + '/' +
            signerOptions.credentialScope + ', SignedHeaders=' + new Canonicalizer().getCanonicalizedSignedHeaders(requestOptions) +
            ', Signature=' + signature;
    }
